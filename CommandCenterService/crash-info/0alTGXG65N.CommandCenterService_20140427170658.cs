...
Callstack Information (PID:20667)
Call Stack Count: 6
 0: Tizen::App::UiApp::GetAppFrame() const + 0x5 (0xb3ad8002) [/usr/lib/osp/libosp-uifw.so] + 0x6ab002
 1: FrameHandler::getOrientation() + 0x4c (0xb269fa4c) [/opt/apps/0alTGXG65N/bin/CommandCenterService.exe] + 0x7a4c
