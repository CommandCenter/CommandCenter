...
PID: 3348
Date: 2014-09-17 11:59:29(GMT+0900)
Executable File Path: /opt/apps/0alTGXG65N/bin/CommandCenterService
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 3348, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00000000
r2   = 0xb24c200c, r3   = 0x00000000
r4   = 0x00000000, r5   = 0x003403e8
r6   = 0x00000000, r7   = 0xaed93d58
r8   = 0xaed94470, r9   = 0xaf593cf4
r10  = 0x00000000, fp   = 0xaed93d70
ip   = 0xb2702abc, sp   = 0xaed93c50
lr   = 0xb26ea1c7, pc   = 0xb3acb982
cpsr = 0x60000030
...
Callstack Information (PID:3348)
Call Stack Count: 8
 0: Tizen::Graphics::Bitmap::GetWidth() const + 0x5 (0xb3acb982) [/usr/lib/osp/libosp-uifw.so] + 0x622982
 1: Tizen::Media::ImageBuffer::Construct(Tizen::Graphics::Bitmap const&) + 0x1a (0xb26ea1c7) [/usr/lib/osp/libosp-image.so.1] + 0xd1c7
 2: getFrameBuffer(unsigned char*) + 0x50 (0xb271c484) [/opt/apps/0alTGXG65N/bin/CommandCenterService.exe] + 0x7484
 3: FrameHandler::getFrameStream() + 0x24 (0xb271c850) [/opt/apps/0alTGXG65N/bin/CommandCenterService.exe] + 0x7850
 4: CommandCenterServiceApp::OnStart() + 0x68 (0xb271aeac) [/opt/apps/0alTGXG65N/bin/CommandCenterService.exe] + 0x5eac
 5: non-virtual thunk to CommandCenterServiceApp::OnStart() + 0x20 (0xb271af38) [/opt/apps/0alTGXG65N/bin/CommandCenterService.exe] + 0x5f38
 6: Tizen::Base::Runtime::_ThreadImpl::ThreadProc(void*) + 0x1e (0xb43393df) [/usr/lib/osp/libosp-appfw.so] + 0x1653df
 7: start_thread + 0xf0 (0xb6f7db1c) [/lib/libpthread.so.0] + 0x5b1c
End of Call Stack
