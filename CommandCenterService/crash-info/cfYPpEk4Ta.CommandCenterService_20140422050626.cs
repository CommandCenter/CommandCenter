...
PID: 4411
Date: 2014-04-22 05:06:26(GMT+0900)
Executable File Path: /opt/apps/cfYPpEk4Ta/bin/CommandCenterService
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 4411, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00000000
r2   = 0xb24ac00c, r3   = 0x00000000
r4   = 0x00000000, r5   = 0x003403e8
r6   = 0x00000000, r7   = 0xb1caad60
r8   = 0xb1cab470, r9   = 0xb24aad04
r10  = 0x00000000, fp   = 0xb1caad70
ip   = 0xb3ab397d, sp   = 0xb1caac50
lr   = 0xb26d41c7, pc   = 0xb3ab3982
cpsr = 0x60000030
...
000dc000 00150000 rw-p [heap]
b25a1000 b25b5000 r-xp /usr/lib/libnetwork.so.0.0.0
b25be000 b25d2000 r-xp /usr/lib/libwifi-direct.so.0.0
b25da000 b25e2000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b25e3000 b25ec000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b25f4000 b26b9000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b26c7000 b26e4000 r-xp /usr/lib/osp/libosp-image.so.1.2.2.0
b26ff000 b2709000 r-xp /opt/usr/apps/cfYPpEk4Ta/bin/CommandCenterService.exe
...
b4189000 b418b000 r-xp /opt/usr/apps/cfYPpEk4Ta/bin/CommandCenterService
...
bea90000 beab1000 rwxp [stack]
End of Maps Information

Callstack Information (PID:4411)
Call Stack Count: 9
 0: Tizen::Graphics::Bitmap::GetWidth() const + 0x5 (0xb3ab3982) [/usr/lib/osp/libosp-uifw.so] + 0x622982
 1: Tizen::Media::ImageBuffer::Construct(Tizen::Graphics::Bitmap const&) + 0x1a (0xb26d41c7) [/usr/lib/osp/libosp-image.so.1] + 0xd1c7
 2: getFrameBuffer(unsigned char*) + 0x44 (0xb270519c) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x619c
 3: FrameHandler::getFrameStream() + 0x24 (0xb2705598) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x6598
 4: CommandCenterServiceApp::Run() + 0x3c (0xb2704334) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x5334
 5: non-virtual thunk to CommandCenterServiceApp::Run() + 0x20 (0xb27043b4) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x53b4
End of Call Stack
