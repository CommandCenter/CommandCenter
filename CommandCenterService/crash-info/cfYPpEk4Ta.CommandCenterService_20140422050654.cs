...
PID: 4702
Date: 2014-04-22 05:06:54(GMT+0900)
Executable File Path: /opt/apps/cfYPpEk4Ta/bin/CommandCenterService
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 4702, uid 5000)
...
Callstack Information (PID:4702)
Call Stack Count: 9
 ...
 3: FrameHandler::getFrameStream() + 0x24 (0xb270556c) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x656c
