...
PID: 5009
Date: 2014-04-22 05:08:48(GMT+0900)
Executable File Path: /opt/apps/cfYPpEk4Ta/bin/CommandCenterService
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 5009, uid 5000)
...
Callstack Information (PID:5009)
Call Stack Count: 9
 ...
 2: getFrameBuffer(unsigned char*) + 0x44 (0xb270523c) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x623c
 3: FrameHandler::getFrameStream() + 0x24 (0xb2705618) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x6618
