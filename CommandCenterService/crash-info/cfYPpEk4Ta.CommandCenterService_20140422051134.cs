...
PID: 5896
Date: 2014-04-22 05:11:34(GMT+0900)
Executable File Path: /opt/apps/cfYPpEk4Ta/bin/CommandCenterService
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 5896, uid 5000)
...
Callstack Information (PID:5896)
Call Stack Count: 9
 ...
 2: getFrameBuffer(unsigned char*) + 0x94 (0xb270528c) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x628c
 3: FrameHandler::getFrameStream() + 0x24 (0xb2705714) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x6714
 4: CommandCenterServiceApp::Run() + 0x3c (0xb27043d4) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x53d4
 5: non-virtual thunk to CommandCenterServiceApp::Run() + 0x20 (0xb2704454) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x5454
End of Call Stack
