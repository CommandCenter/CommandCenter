...
PID: 6957
Date: 2014-04-22 05:27:44(GMT+0900)
Executable File Path: /opt/apps/cfYPpEk4Ta/bin/CommandCenterService
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 6957, uid 5000)
...
Callstack Information (PID:6957)
Call Stack Count: 9
 ...
 2: getFrameBuffer(unsigned char*) + 0x60 (0xb2705150) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x6150
 3: FrameHandler::getFrameStream() + 0x24 (0xb27055a4) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x65a4
