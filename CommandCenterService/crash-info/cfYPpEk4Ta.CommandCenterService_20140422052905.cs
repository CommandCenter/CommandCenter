...
Callstack Information (PID:7245)
Call Stack Count: 9
 ...
 2: getFrameBuffer(unsigned char*) + 0x90 (0xb2705180) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x6180
 3: FrameHandler::getFrameStream() + 0x24 (0xb2705614) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x6614
 4: CommandCenterServiceApp::Run() + 0x3c (0xb27042cc) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x52cc
 5: non-virtual thunk to CommandCenterServiceApp::Run() + 0x20 (0xb270434c) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x534c
End of Call Stack
