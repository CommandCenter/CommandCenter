...
PID: 7574
Date: 2014-04-22 05:31:45(GMT+0900)
Executable File Path: /opt/apps/cfYPpEk4Ta/bin/CommandCenterService
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 7574, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00000000
r2   = 0xc24c9300, r3   = 0x00000000
r4   = 0x00000000, r5   = 0x003403e8
r6   = 0x00000000, r7   = 0x0012a4f0
r8   = 0xb1cab470, r9   = 0xb24aad04
r10  = 0x00000000, fp   = 0xb1caad70
ip   = 0xb3ab397d, sp   = 0xb1caac18
...
b26ff000 b270a000 r-xp /opt/usr/apps/cfYPpEk4Ta/bin/CommandCenterService.exe
...
Callstack Information (PID:7574)
Call Stack Count: 9
 ...
 2: getFrameBuffer(unsigned char*) + 0xa8 (0xb2705150) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x6150
 3: FrameHandler::getFrameStream() + 0x24 (0xb27055d4) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x65d4
 4: CommandCenterServiceApp::Run() + 0x3c (0xb2704284) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x5284
 5: non-virtual thunk to CommandCenterServiceApp::Run() + 0x20 (0xb2704304) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x5304
End of Call Stack
