...
PID: 7977
Date: 2014-04-22 05:32:50(GMT+0900)
Executable File Path: /opt/apps/cfYPpEk4Ta/bin/CommandCenterService
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 7977, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00000000
r2   = 0xb24ac00c, r3   = 0x00127a40
...
Callstack Information (PID:7977)
Call Stack Count: 8
 0: Tizen::Graphics::Bitmap::GetWidth() const + 0x5 (0xb3ab3982) [/usr/lib/osp/libosp-uifw.so] + 0x622982
 1: getFrameBuffer(unsigned char*) + 0x4c (0xb27050f4) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x60f4
 2: FrameHandler::getFrameStream() + 0x24 (0xb2705620) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x6620
