...
PID: 8261
Date: 2014-04-22 05:33:11(GMT+0900)
Executable File Path: /opt/apps/cfYPpEk4Ta/bin/CommandCenterService
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 8261, uid 5000)
...
ip   = 0xb3ab397d, sp   = 0xb1caac38
lr   = 0xb2705124, pc   = 0xb3ab3982
cpsr = 0x60000030
...
Callstack Information (PID:8261)
Call Stack Count: 8
 0: Tizen::Graphics::Bitmap::GetWidth() const + 0x5 (0xb3ab3982) [/usr/lib/osp/libosp-uifw.so] + 0x622982
 1: getFrameBuffer(unsigned char*) + 0x7c (0xb2705124) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x6124
 2: FrameHandler::getFrameStream() + 0x24 (0xb2705654) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x6654
