...
Callstack Information (PID:10414)
Call Stack Count: 8
 0: Tizen::Graphics::Bitmap::GetWidth() const + 0x5 (0xb3ab3982) [/usr/lib/osp/libosp-uifw.so] + 0x622982
 1: getFrameBuffer(unsigned char*) + 0xb0 (0xb2705158) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x6158
 2: FrameHandler::getFrameStream() + 0x24 (0xb2705690) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x6690
 3: CommandCenterServiceApp::Run() + 0x3c (0xb2704284) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x5284
 4: non-virtual thunk to CommandCenterServiceApp::Run() + 0x20 (0xb2704304) [/opt/apps/cfYPpEk4Ta/bin/CommandCenterService.exe] + 0x5304
End of Call Stack
